...
def banner():
    ...
    runntxt(WW+" _____ __________")
    runntxt(WW+"|  ___|___ /__  /")
    runntxt(GL+"| |_    |_ \ / /")
    runntxt(GG+"|  _|  ___) / /_")
    runntxt(Y+" |_|   |____/____|")    
    runntxt(GG+"
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW TOOLS HACK FACEBOOK BF.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |          CRATED BY : F3Z_ID                 |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |            FACEBOOK: F-RREL ID              |"
    print Y+"   |            INSTAGRAM: @FARREL27_            |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |     BOJONEGORO CYBER SECURITU [ B.C.S ]     |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
...
print wd+"         https://www.github.com/xF3Zx "
...
def life():
	...
	for iqbalz_password in password_nob:
		password_nob = f3z_password.replace("\n","")
		f3z(f3z_password)		
